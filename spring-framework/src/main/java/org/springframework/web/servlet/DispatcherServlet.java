...
public class DispatcherServlet extends HttpServlet {
    ...
    private List<ViewResovler> viewResovlers = new ArrayList<ViewResovler>();
     ...
     * @param modelAndView
     */
    public void processDispatchResult(HttpServletRequest req, HttpServletResponse resp, ModelAndView modelAndView) throws IOException{
